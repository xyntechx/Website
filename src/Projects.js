            ...
            <body className="App-body">
                ...
                <div style={{width:'60%'}} class="module-border-wrap">
                    <div class="module">
                        ...
                        <p>This project is a Django web application for Quditi, a startup of which I am a founding member! This web application hosts coding challenges for people to attempt and complete.</p>
                    </div>
                </div>
